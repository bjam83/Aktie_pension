...
export const NAV_ITEMS: NavItem[] = [
  { href: "/", label: "Overblik", icon: "M4 18h4v-8H4zm6 0h4V6h-4zm6 0h4V2h-4z" },
  { href: "/husstand", label: "Husstand", icon: "M4 21V10l8-6 8 6v11h-5v-6H9v6z" },
  { href: "/pension", label: "Pension", icon: "M3 17l4-5 4 4 4-6 5 4" },
  { href: "/investeringer", label: "Investeringer", icon: "M4 20V10m6 10V4m6 16v-7m6 7V8" },
  ...
  { href: "/budget", label: "Budget", icon: "M3 6h18M3 12h18M3 18h10" },
